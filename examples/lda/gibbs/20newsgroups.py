...
# run LDA
lda = Gibbs(n_topics=5, doc_topic_prior=0.01, topic_word_prior=0.01)
for result in lda.infer(documents, n_sweeps=100):
  pass

# print out most popular words per topic
final_topic_word = result['topic_word_counts']
